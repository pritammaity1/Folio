    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[var(--color-primary-container)] font-body text-xs font-semibold text-[var(--color-on-primary)]"
              aria-hidden="true"
            >
              P
            </div>
            ...
            {!collapsed && (
              <div className="min-w-0">
                <p className="truncate font-body text-xs font-semibold text-[var(--color-on-surface)]">
                  Pritam
                </p>

                <p className="truncate font-body text-[11px] text-[var(--color-on-surface-variant)]">
                  Editor
                </p>
              </div>
            )}
